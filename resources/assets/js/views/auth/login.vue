                  ...
                  <div class="card-body">
                   <form class="form-horizontal form-material" id="loginform" @submit.prevent="submit">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input type="text" name="email" class="form-control" placeholder="Email" v-model="loginForm.email"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                            <div class="social">
                                <a href="/auth/social/linkedin" class="btn  btn-linkedin" data-toggle="tooltip" title="Login with linkedin"> <i aria-hidden="true" class="fa fa-linkedin"></i> </a>
